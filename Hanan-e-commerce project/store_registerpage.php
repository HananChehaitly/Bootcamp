      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <h2 class="text-center">
            ...
            $x = $_SESSION["mail"];
            echo $x;}
            elseif(!empty($_SESSION["landline"])){
            $x = $_SESSION["landline"];
            echo $x;}
    ...
    ?>
          ...
          <form class="text-left clearfix" action="store_register.php" method="POST" id="signupForm">
            <div class="form-group" id ="fn">
              <input type="text" class="form-control"  placeholder="Store Name" name="store_name" id ="f">
            </div>
        
            <div class="form-group">
              <label class="label" id="phone"></label> 
              <input type="text" class="form-control"  placeholder="Landline" name="landline" id="l">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <!--those categories are predefined. However, the home pages are coded in a responsive way to any change. -->
